...
export function Comment ({comment} : {comment: IPostCommentWithUserAndRatings}) {
...
export default function CommentDialog() {
    ...
    if(!post) return null
    return <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center h-full w-full">
        <div className="bg-white min-h-[400px] min-w-[400px] p-4 rounded-lg relative">
            ...
            <div className="w-full absolute bottom-[.5rem] left-[.25rem]" style={{display:'grid', gridTemplateColumns:'90% 10%',placeItems:'center'}}>
                <input ref={ref} type="text" placeholder="Write a comment..." className="w-full border-[1px] border-[lightgray] p-2 rounded-md"/>
